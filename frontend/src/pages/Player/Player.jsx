...
const Player = () => {
  ...
  const [movieTitle, setMovieTitle] = useState(""); // busca no YouTube se necessário
  ...
  useEffect(() => {
    ...
    // Busca os dados do filme para pegar o nome dele
    ...
    fetch(`https://api.themoviedb.org/3/movie/${id}/videos?language=en-US`, options)
      ...
      .then(res => {
        ...
        if (trailers.length > 0) {
          ...
          // Se não encontrou, busca em português
